...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/red/CSS/style.css">
    <link rel="stylesheet" type="text/css" href="/red/CSS/registration.css">
...
<body>
    <section class="registration-form">
      ...
      ?>
        ...
        <form id="registration" method="post" action="/red/register/registration.php" enctype="multipart/form-data">
            ...
            <div class="picture-box" id="pictureBox">
                <img src="/red/pic/cloud-upload.png" alt="upload icon" onclick="getImage()">
