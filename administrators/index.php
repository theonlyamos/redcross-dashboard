...
<body>
    <div class="modal w-100" id="userModal">
        ...
        ?>
            ...
            <form id="registration" method="post" action="/redcross/administrators/add/registration.php" enctype="multipart/form-data">
        ...
        <div class="main__container overflow-y-auto">
            ...
            <div class="main__title d-flex align-items-center m-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="main__greeting ml-2">
                        ...
                        <p class="text-accent">Administrators</p>
                    </div>
                </div>
            </div>
            <div class="main__card d-flex justify-content-center ml-1">
                <div class="card pb-2 px-1 w-90 mb-1 search-container" id="searchContainer">
                    <form action="/redcross/administrators/search.php" method="POST" class="d-flex flex-row flex-wrap justify-content-between">
    ...
    <script src="/redcross/dashboard/public/js/administrators.js"></script>
</body>
